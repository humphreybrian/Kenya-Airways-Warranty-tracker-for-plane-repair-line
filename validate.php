...
if (!empty($_POST["save_record"])) {
    $pdo_statement = $DB_con->prepare("update t_items_warranty set signoff='" . $_POST['validate'] . "'  where id=" . $_GET["id"]);
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control border-input demo-form-field"
                                                       value="<?php echo $result1[0]['DATERCD']; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control border-input demo-form-field"
                                                       value="<?php echo $result1[0]['DATERMVD']; ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control border-input demo-form-field"
                                                       value="<?php echo $_SESSION['displayname']; ?>" type=""
                                                       name="code" readonly>
                                            </div>
