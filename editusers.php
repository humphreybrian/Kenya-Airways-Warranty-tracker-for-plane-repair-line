...
if (!empty($_POST["save_record"])) {
    $pdo_statement = $DB_con->prepare("update t_users_warranty set username='" . $_POST['username'] . "', role='" . $_POST['role'] . "', code='" . $_POST['code'] . "' where id=" . $_GET["id"]);
    $result = $pdo_statement->execute();
    if ($result) {
        header('location:manageusers.php');
    }
}
$pdo_statement = $DB_con->prepare("SELECT * FROM t_users_warranty where id=" . $_GET["id"]);
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input demo-form-field"
                                                       value="<?php echo $result[0]['USERNAME']; ?>" name="username"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>ROLE</label>
                                                <input type="text" class="form-control border-input demo-form-field"
                                                       value="<?php echo $result[0]['ROLE']; ?>" name="role"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>CODE</label>
                                                <input type="text" class="form-control border-input demo-form-field"
                                                       value="<?php echo $result[0]['CODE']; ?>" name="code"
                                                       placeholder="TAG">
                                            </div>
                                        </div>
                                        <!--  <div class="col-md-4">
