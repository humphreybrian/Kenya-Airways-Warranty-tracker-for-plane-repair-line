                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="col-md-11 text-center">
                                            ...
                                            <div class="progress col-md-11">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="{{$outboundPercentage}}" aria-valuemin="0" aria-valuemax="100" style="width:60%" >
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="col-md-11 text-center">
                                            ...
                                            <div class="progress col-md-11">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="{{$inboundPercentage}}" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
                       ...
                       <!-- Delayed arrivals  -->
                            <div class="col-md-8">
                                <div class="panel panel-danger">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-6">
                                            <p class="panel panel-default"><span> < 15 Mins</span> <span class="pull-right"> 66</span></p>
                                            <p class="panel panel-default"><span> >15 Mins </span> <span class="pull-right"> 55</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                           <!-- on time departures  -->
                             <div class="col-md-4">
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            <p class="panel panel-default"><span>Total Departures </span> <span class="pull-right">  545</span></p>
                                            <p class="panel panel-default"><span>On Time </span> <span class="pull-right"> 32</span></p>
                                        </div>
                            ...
                            <div class="col-md-8">
                                <div class="panel panel-danger">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-6">
                                            <p class="panel panel-default"><span>GND </span> <span class="pull-right"> 15/34</span></p>
                                            <p class="panel panel-default"><span>COO </span> <span class="pull-right"> 5/23</span></p>
                                        </div>
                                        <div class="col-md-6">
                                            <p class="panel panel-default"><span>FOP</span> <span class="pull-right"> 12/300</span></p>
                                            <p class="panel panel-default"><span>>TECH </span> <span class="pull-right"> 5/120</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                             ...
                             <div class="col-md-4">
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            <p class="panel panel-default"><span>Total Arivals </span> <span class="pull-right"> 34</span></p>
                                            <p class="panel panel-default"><span>On Time </span> <span class="pull-right">44</span></p>
                                        </div>
