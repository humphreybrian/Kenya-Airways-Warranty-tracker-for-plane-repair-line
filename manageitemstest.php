                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
                                <div class="container">
                                    ...
                                    <table class="tbl-qa table table table-bordered table-responsive " cellpadding="2"
                                           cellspacing="1">
                                        <thead>
                                        <tr>
                                            ...
                                            foreach ($result as $row) {
                                                ...
                                                <tr class="table-row">
                                                    ...
                                                    <td><a class="ajax-action-links"
                                                           href='edititems.php?id=<?php echo $row['ID']; ?>'><img
                                                                    src="crud-icon/edit.png" title="Edit"/></a> <a
                                                                class="ajax-action-links"
                                                                href='deleteitems.php?id=<?php echo $row['ID']; ?>'><img
                                                                    src="crud-icon/delete.png" title="Delete"/></a></td>
                                                </tr>
                                                <?php
                                            }
                                        }
