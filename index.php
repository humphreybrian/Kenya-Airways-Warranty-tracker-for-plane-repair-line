...
} else if (isset($_SESSION['sess_username']) && ($_SESSION['sess_userrole'] == 'certify')) {
    header('Location: dashboard.php');
}
?>
<?php
if (isset($_POST['btnLogin'])) {
    ...
    if (empty($_POST['username']) || empty($_POST['password'])) {
        ...
        if (!$info) {
            ...
            $q = 'SELECT COUNT(*) FROM t_users_warranty WHERE username=:username ';
            $q1 = 'SELECT * FROM t_users_warranty WHERE username=:username';
            ...
            if ($query->fetchColumn() == 0) {
                ...
                $query1->execute(array(':username' => $_POST['username']));
...
<div class="containera">
    <div class="info">
        <h1 class="h1" style="font-family: 'Lato', sans-serif; font-weight: 700; font-style: italic; ">Kenya Airways
            Workshop Tracker</h1>
...
<div class="form">
    ...
    $errors = array(
        ...
        4 => "Not allowed to access this app"
    );
