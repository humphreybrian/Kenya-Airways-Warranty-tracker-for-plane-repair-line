...
if (!empty($_POST["add_record"])) {
    ...
    if (!empty($result)) {
        if (isset($_POST['quarry']) and $_POST['quarry'] == 1) {
            header("location:parts_awaited.php?partnum=" . $_POST['partnumber']);
        } elseif (isset($_POST['quarry']) and $_POST['quarry'] == 0) {
                                ...
                                <form name="frmAdd" action="" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input demo-form-field"
                                                       name='inspecno' placeholder="WORKORDER NUMBER"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input demo-form-field"
                                                       name="partnumber" placeholder="PART NUMBER" required="required">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control border-input demo-form-field"
                                                       name="datercd" placeholder="DATE RECEIVED" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control border-input demo-form-field"
                                                       name="datermvd" placeholder="DATE REMOVED" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $pdo_DATECOMPLETEDment = $DB_con->prepare("SELECT TYPE FROM t_aircrafts_warranty");
                                                $pdo_DATECOMPLETEDment->execute();
                                                $result = $pdo_DATECOMPLETEDment->fetchAll();
                                                ?>


                                                <select id="INSPECNO" title="department"
                                                        class="form-control border-input demo-form-field" name="actype"
                                                        id="DATECOMPLETED" placeholder="AIRCRAFT TYPE">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $pdo_DATECOMPLETEDment = $DB_con->prepare("SELECT REGNUM FROM t_airregnum_warranty");
                                                $pdo_DATECOMPLETEDment->execute();
                                                $result = $pdo_DATECOMPLETEDment->fetchAll();
                                                ?>
                                                ...
                                                <select id="INSPECNO" title="department"
                                                        ...
                                                        id="DATECOMPLETED" placeholder="AIRCRAFT REGISTRATION NUMBER">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input demo-form-field"
                                                       name="pos" placeholder="POSITION" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input demo-form-field"
                                                       name="hoursrun" placeholder="HOURS RUN" required="required">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control border-input demo-form-field"
                                                       name="qty" placeholder="QUATITY" required="number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>DEFECT</label>
                                                <input type="text" class="form-control border-input demo-form-field"
                                                       name="defect" placeholder="DEFECT" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $pdo_DATECOMPLETEDment = $DB_con->prepare("SELECT CATEGORY FROM t_categories_warranty");
                                                $pdo_DATECOMPLETEDment->execute();
                                                $result = $pdo_DATECOMPLETEDment->fetchAll();
                                                ?>


                                                <select name="category" id="category" title="department"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>UNIT</label>
                                                <?php
                                                $pdo_DATECOMPLETEDment = $DB_con->prepare("SELECT UNITS FROM t_UNITs_warranty");
                                                $pdo_DATECOMPLETEDment->execute();
                                                $result = $pdo_DATECOMPLETEDment->fetchAll();
                                                ?>

                                                <select name="unit" id="UNIT" title="department"
                                                        class="form-control border-input demo-form-field"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <!--  <input type="text" class="form-control border-input demo-form-field datepicke" name="quarantine" placeholder="QUARANTINE POSITION" > -->
                                                <select title="department"
                                                        class="form-control border-input demo-form-field" name="quarry"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       name="modstatus" placeholder="ADD NEW PARTNUMBER"
                                                       required="required">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control border-input demo-form-field"
                                                   name='workorder' placeholder="WORK ORDER NUMBER" required="required">
                                        </div>
                                        <!-- </div> -->
                                        <!--  <div class="col-md-4"> -->
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="authority" placeholder="DATE REMOVED" required="required">
                                        </div>
                                        <!--  </div> -->
                                        <!-- <div class="col-md-4"> -->
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="sentto" placeholder="DATE REMOVED" required="required">
                                        </div>
                                        <!-- </div> -->
                                        <!-- <div class="col-md-4"> -->
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="deleted" placeholder="DATE REMOVED" required="required">
                                        </div>
                                        <!-- </div> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="lastuserupdate" placeholder="DATE REMOVED" required="required">
                                        </div>
                                        <!-- </div> -->
                                        <!-- <div class="col-md-4"> -->
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="lastdateupdate" placeholder="DATE REMOVED" required="required">
                                        </div>
                                        <!-- </div> -->
                                        <!-- <div class="col-md-4"> -->
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="lastactionupdate" placeholder="DATE REMOVED"
                                                   required="required">
                                        </div>
                                        <!-- </div> -->
                                        <!-- <div class="col-md-4"> -->
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="scrapped" placeholder="DATE REMOVED" required="required">
                                        </div>
                                        <!-- </div> -->
                                        <!-- <div class="col-md-4"> -->
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="sector" placeholder="DATE REMOVED" required="required">
                                        </div>
                                        <!-- </div> -->
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control border-input demo-form-field"
                                                   name="inspecno_old" placeholder="DEFECT" required="required">
                                        </div>
                                        <!--   </div> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control border-input demo-form-field"
                                                   name="workdone" placeholder="DEFECT" required="required">
                                        </div>
                                        <!--    </div> -->
                                        <!-- <div class="col-md-4"> -->
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="deactivatereason" placeholder="DATE REMOVED"
                                                   required="required">
                                        </div>
                                        <!--  </div> -->
                                        <!-- <div class="col-md-4"> -->
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control border-input demo-form-field"
                                                   name="tech" value="<?php echo $_SESSION['displayname']; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="datecompleted" placeholder="DATE REMOVED" required="required">
                                        </div>
                                        <!-- </div> -->
                                        <!-- <div class="col-md-4"> -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"
                                                   class="form-control border-input demo-form-field datepicke"
                                                   name="manhours" placeholder="DATE REMOVED" required="required">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" name="add_record" value="Add"
                                                class="btn btn-danger btn-fill btn-wd demo-form-submit">ADD ITEM
                                        </button>
                                    </div>
