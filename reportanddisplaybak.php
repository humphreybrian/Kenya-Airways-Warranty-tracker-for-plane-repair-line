...
if (isset($_GET['category'])  && $_GET['category'] != null) {
    ...
    $sql ='SELECT * FROM items WHERE category LIKE ? AND acreg LIKE ? AND actype LIKE ? AND( ( DATERCD BETWEEN ? and ?) OR ( POSTEDAT BETWEEN ? and ?) )';
    $q = $DB_con->prepare($sql);
    $q->execute(array($category,$reg,$typp,$start_date,$stop_date,$start_date,$stop_date));
...
<div class="container" style="background: #fff;" >
    <div class="row">
      ...
      <div class="info col-md-12">
                                    <form>
                                    <input type=button name=print value="Print Report" onClick="window.print()" class="btn btn-danger btn-fill btn-wd demo-form-submit">
                                    </form>
            <h3 class="h3 text-center" style="font-family: 'Lato', sans-serif; font-weight: 100; font-style: italic; ">Kenya Airways Workshop System</h3>
            <h4>Kenya Airways Workshop Tracker<br>Reports for Workshop Tracker<br> for a period of <?php echo $start_date = date('d/M/Y',strtotime($_GET['date1']));?> to <?php echo $stop_date  = date('d/M/Y',strtotime($_GET['date2']));?>, <br> Done by <?php echo $_SESSION['displayname']; ?>, <br> On <?php echo date("d-M-Y h:i:s a"); ?>. </h4>
